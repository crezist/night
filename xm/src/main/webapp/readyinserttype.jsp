...
<html>
  ...
  <body>
    ...
    <td>类型级别</td>
    <td>
    <label><input name="tplevel" type="radio" value=1>1</label>
    &nbsp;&nbsp;
    <label><input checked="checked" name="tplevel" type="radio" value=2>2</label>
    &nbsp;&nbsp;
    <label><input name="tplevel" type="radio" value=3>3</label>
    </td>
    </tr>
